...
export default function UrlShortener() {
  ...
  const { user } = useAuth();
  const { addUrl, getUserUrls, deleteUrl } = useFirestore();
            ...
            <Box>
              {!user && (
                <Alert severity="info" sx={{ mb: 3, borderRadius: 2 }}>
                  Puedes acortar URLs de forma libre y pública. Si deseas guardar tus enlaces acortados en tu cuenta para hacer un seguimiento de sus clics, ver estadísticas e historial, por favor inicia sesión con Google usando el botón en la barra superior derecha.
                </Alert>
              )}
